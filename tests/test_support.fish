function setup_forge_test_env
    ...
    for var in         _FORGE_PLUGIN_INITIALIZED         _FORGE_PLUGIN_ROOT         _FORGE_BIN         _FORGE_ACTIVE_AGENT         _FORGE_CONVERSATION_ID         _FORGE_PREVIOUS_CONVERSATION_ID         _FORGE_SESSION_MODEL         _FORGE_SESSION_PROVIDER         _FORGE_SESSION_REASONING_EFFORT         _FORGE_TERM         _FORGE_TERM_MAX_COMMANDS         _FORGE_TERM_COMMANDS         _FORGE_TERM_EXIT_CODES         _FORGE_TERM_TIMESTAMPS         _FORGE_COMMANDS_CACHE         _FORGE_MODELS_CACHE         _FORGE_LAST_BUFFER_ACTION         _FORGE_PROMPT_ENABLED         _FORGE_PROMPT_MODEL         _FORGE_PROMPT_TOKENS         _FORGE_PROMPT_COST
        set -e $var
    end
